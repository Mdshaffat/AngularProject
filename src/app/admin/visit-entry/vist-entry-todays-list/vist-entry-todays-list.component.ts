...
@Component({
  selector: 'app-vist-entry-todays-list',
  templateUrl: './vist-entry-todays-list.component.html',
  styleUrls: ['./vist-entry-todays-list.component.css']
})
export class VistEntryTodaysListComponent implements OnInit , AfterViewInit {
